...
// // render tasks
// renderTasks: async () => {
// 	const taskCounter = await App.TodoList.methods.taskCounter().call({
// 		gas: 6000000,
// 		from: App.account,
// 	});
...
// 		try {
// 			const result = await App.TodoList.methods.createTask(title, description).call({
// 				gas: 6000000,
// 				from: App.account,
// 			});
// 			alert("After the transaction completes, please refresh the webpage.")
...
// 			await App.TodoList.methods.toggleDone(taskId).call({
// 				gas: 6000000,
// 				from: App.account,
// 			});
// 			window.location.reload();
